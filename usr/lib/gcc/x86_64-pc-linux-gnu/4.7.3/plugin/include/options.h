...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 987,             /* -m128bit-long-double */
  OPT_m32 = 988,                             /* -m32 */
  OPT_m3dnow = 989,                          /* -m3dnow */
  OPT_m3dnowa = 990,                         /* -m3dnowa */
  OPT_m64 = 991,                             /* -m64 */
  OPT_m80387 = 992,                          /* -m80387 */
  OPT_m8bit_idiv = 993,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 994,              /* -m96bit-long-double */
  OPT_mabi_ = 995,                           /* -mabi= */
  OPT_mabm = 996,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 997,       /* -maccumulate-outgoing-args */
  OPT_maes = 998,                            /* -maes */
  OPT_malign_double = 999,                   /* -malign-double */
  OPT_malign_functions_ = 1000,              /* -malign-functions= */
  OPT_malign_jumps_ = 1001,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1002,                  /* -malign-loops= */
  OPT_malign_stringops = 1003,               /* -malign-stringops */
  OPT_mandroid = 1004,                       /* -mandroid */
  OPT_march_ = 1005,                         /* -march= */
  OPT_masm_ = 1006,                          /* -masm= */
  OPT_mavx = 1007,                           /* -mavx */
  OPT_mavx2 = 1008,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1009,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1010,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1011,                        /* -mbionic */
  OPT_mbmi = 1012,                           /* -mbmi */
  OPT_mbmi2 = 1013,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1014,                  /* -mbranch-cost= */
  OPT_mcld = 1015,                           /* -mcld */
  OPT_mcmodel_ = 1016,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1017, */                    /* -mcpu= */
  OPT_mcrc32 = 1018,                         /* -mcrc32 */
  OPT_mcx16 = 1019,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1020,            /* -mdispatch-scheduler */
  OPT_mf16c = 1021,                          /* -mf16c */
  OPT_mfancy_math_387 = 1022,                /* -mfancy-math-387 */
  OPT_mfentry = 1023,                        /* -mfentry */
  OPT_mfma = 1024,                           /* -mfma */
  OPT_mfma4 = 1025,                          /* -mfma4 */
  OPT_mforce_drap = 1026,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1027,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1028,                       /* -mfpmath= */
  OPT_mfsgsbase = 1029,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1030, */              /* -mfused-madd */
  OPT_mglibc = 1031,                         /* -mglibc */
  OPT_mhard_float = 1032,                    /* -mhard-float */
  OPT_mieee_fp = 1033,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1034,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1035,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1036,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1037, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1038,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1039,                           /* -mlwp */
  OPT_mlzcnt = 1040,                         /* -mlzcnt */
  OPT_mmmx = 1041,                           /* -mmmx */
  OPT_mmovbe = 1042,                         /* -mmovbe */
  OPT_mms_bitfields = 1043,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1044,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1045,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1046,                  /* -mno-push-args */
  OPT_mno_red_zone = 1047,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1048,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1049,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1050,                          /* -mpc32 */
  OPT_mpc64 = 1051,                          /* -mpc64 */
  OPT_mpc80 = 1052,                          /* -mpc80 */
  OPT_mpclmul = 1053,                        /* -mpclmul */
  OPT_mpopcnt = 1054,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1055,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1056,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1057,                     /* -mpush-args */
  OPT_mrdrnd = 1058,                         /* -mrdrnd */
  OPT_mrecip = 1059,                         /* -mrecip */
  OPT_mrecip_ = 1060,                        /* -mrecip= */
  OPT_mred_zone = 1061,                      /* -mred-zone */
  OPT_mregparm_ = 1062,                      /* -mregparm= */
  OPT_mrtd = 1063,                           /* -mrtd */
  OPT_msahf = 1064,                          /* -msahf */
  OPT_msoft_float = 1065,                    /* -msoft-float */
  OPT_msse = 1066,                           /* -msse */
  OPT_msse2 = 1067,                          /* -msse2 */
  OPT_msse2avx = 1068,                       /* -msse2avx */
  OPT_msse3 = 1069,                          /* -msse3 */
  OPT_msse4 = 1070,                          /* -msse4 */
  OPT_msse4_1 = 1071,                        /* -msse4.1 */
  OPT_msse4_2 = 1072,                        /* -msse4.2 */
  OPT_msse4a = 1073,                         /* -msse4a */
  /* OPT_msse5 = 1074, */                    /* -msse5 */
  OPT_msseregparm = 1075,                    /* -msseregparm */
  OPT_mssse3 = 1076,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1077,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1078,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1079,            /* -mstringop-strategy= */
  OPT_mtbm = 1080,                           /* -mtbm */
  OPT_mtls_dialect_ = 1081,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1082,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1083,                         /* -mtune= */
  OPT_muclibc = 1084,                        /* -muclibc */
  OPT_mveclibabi_ = 1085,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1086,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1087,                    /* -mvzeroupper */
  OPT_mx32 = 1088,                           /* -mx32 */
  OPT_mxop = 1089,                           /* -mxop */
  OPT_n = 1090,                              /* -n */
  OPT_no_canonical_prefixes = 1091,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1092,              /* -no-integrated-cpp */
  OPT_nocpp = 1093,                          /* -nocpp */
  OPT_nodefaultlibs = 1094,                  /* -nodefaultlibs */
  OPT_nopie = 1095,                          /* -nopie */
  OPT_nostartfiles = 1096,                   /* -nostartfiles */
  OPT_nostdinc = 1097,                       /* -nostdinc */
  OPT_nostdinc__ = 1098,                     /* -nostdinc++ */
  OPT_nostdlib = 1099,                       /* -nostdlib */
  OPT_o = 1100,                              /* -o */
  OPT_p = 1101,                              /* -p */
  OPT_pass_exit_codes = 1102,                /* -pass-exit-codes */
  OPT_pedantic = 1103,                       /* -pedantic */
  OPT_pedantic_errors = 1104,                /* -pedantic-errors */
  OPT_pg = 1105,                             /* -pg */
  OPT_pie = 1106,                            /* -pie */
  OPT_pipe = 1107,                           /* -pipe */
  OPT_posix = 1108,                          /* -posix */
  OPT_print_file_name_ = 1109,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1110,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1111,          /* -print-multi-directory */
  OPT_print_multi_lib = 1112,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1113,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1114,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1115,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1116,               /* -print-prog-name= */
  OPT_print_search_dirs = 1117,              /* -print-search-dirs */
  OPT_print_sysroot = 1118,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1119,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1120,                        /* -profile */
  OPT_pthread = 1121,                        /* -pthread */
  OPT_quiet = 1122,                          /* -quiet */
  OPT_r = 1123,                              /* -r */
  OPT_rdynamic = 1124,                       /* -rdynamic */
  OPT_remap = 1125,                          /* -remap */
  OPT_s = 1126,                              /* -s */
  OPT_s_bc_abi = 1127,                       /* -s-bc-abi */
  OPT_save_temps = 1128,                     /* -save-temps */
  OPT_save_temps_ = 1129,                    /* -save-temps= */
  OPT_shared = 1130,                         /* -shared */
  OPT_shared_libgcc = 1131,                  /* -shared-libgcc */
  /* OPT_specs = 1132, */                    /* -specs */
  OPT_specs_ = 1133,                         /* -specs= */
  OPT_static = 1134,                         /* -static */
  OPT_static_libgcc = 1135,                  /* -static-libgcc */
  OPT_static_libgcj = 1136,                  /* -static-libgcj */
  OPT_static_libgfortran = 1137,             /* -static-libgfortran */
  OPT_static_libgo = 1138,                   /* -static-libgo */
  OPT_static_libstdc__ = 1139,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1140, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1141, */                /* -std=c++0x */
  OPT_std_c__11 = 1142,                      /* -std=c++11 */
  OPT_std_c__98 = 1143,                      /* -std=c++98 */
  OPT_std_c11 = 1144,                        /* -std=c11 */
  /* OPT_std_c1x = 1145, */                  /* -std=c1x */
  /* OPT_std_c89 = 1146, */                  /* -std=c89 */
  OPT_std_c90 = 1147,                        /* -std=c90 */
  OPT_std_c99 = 1148,                        /* -std=c99 */
  /* OPT_std_c9x = 1149, */                  /* -std=c9x */
  OPT_std_f2003 = 1150,                      /* -std=f2003 */
  OPT_std_f2008 = 1151,                      /* -std=f2008 */
  OPT_std_f2008ts = 1152,                    /* -std=f2008ts */
  OPT_std_f95 = 1153,                        /* -std=f95 */
  OPT_std_gnu = 1154,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1155, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1156, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1157,                    /* -std=gnu++11 */
