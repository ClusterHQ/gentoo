...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--build=x86_64-pc-linux-gnu' '--host=x86_64-pc-linux-gnu' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--datadir=/usr/share' '--sysconfdir=/etc' '--localstatedir=/var/lib' '--libdir=/usr/lib64' '--disable-internal-md5' '--enable-ipv6' '--disable-mfd-rewrites' '--disable-embedded-perl' '--disable-ucd-snmp-compatibility' '--with-bzip2' '--without-elf' '--without-mysql' '--without-nl' '--without-pci' '--without-perl-modules' '--without-python-modules' '--without-rpm' '--with-openssl' '--with-libwrap' '--with-zlib' '--enable-shared' '--disable-static' '--with-default-snmp-version=3' '--with-install-prefix=/var/tmp/portage/net-analyzer/net-snmp-5.7.3_pre3/image/' '--with-ldflags=-Wl,-O1 -Wl,--as-needed -Wl,--hash-style=gnu' '--with-logfile=/var/log/net-snmpd.log' '--with-mib-modules=host ucd-snmp/dlmod ucd-snmp/diskio ucd-snmp/extensible mibII/mta_sendmail smux' '--with-persistent-directory=/var/lib/net-snmp' '--with-sys-contact=root@Unknown' '--with-sys-location=Unknown' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'CFLAGS=-march=core2 -mtune=core2 -mcx16 -msahf -msse4.1 --param l1-cache-size=32 --param l1-cache-line-size=64 --param l2-cache-size=6144 -O2 -pipe -ggdb' 'LDFLAGS=-Wl,-O1 -Wl,--as-needed -Wl,--hash-style=gnu'"
...
#define PACKAGE_STRING "Net-SNMP 5.7.3.pre3"
#endif
...
#define PACKAGE_VERSION "5.7.3.pre3"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":HOST-RESOURCES-MIB:HOST-RESOURCES-TYPES:UCD-DLMOD-MIB:UCD-DISKIO-MIB:MTA-MIB:NETWORK-SERVICES-MIB:SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IPV6-ICMP-MIB:IPV6-MIB:IPV6-TCP-MIB:IPV6-UDP-MIB:IP-FORWARD-MIB:NET-SNMP-PASS-MIB:NET-SNMP-EXTEND-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
...
#define NETSNMP_SYS_CONTACT "root@Unknown"
