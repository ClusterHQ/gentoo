...
"x86_64-linux-3.10.0-123.6.3.el7.x86_64" or
	die "Errno architecture (x86_64-linux-3.10.0-123.6.3.el7.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
