...
#define	DB_VERSION_PATCH	42
#define	DB_VERSION_STRING	"Berkeley DB 5.2.42: (February 29, 2012)"
#define	DB_VERSION_FULL_STRING	"Berkeley DB 11g Release 2, library version 11.2.5.2.42: (February 29, 2012)"
