...
function parse_ld_conf(conf,    pipe, ldsoconf_data, CHILD, y) {
	pipe = "cd /home/core/gentoo/etc; cat " conf " | sort 2>/dev/null"
...
BEGIN {
	...
	LIBCOUNT = 2
	HAVE_GCC34 = 0
	DIRLIST[1] = "/home/core/gentoo/lib"
	DIRLIST[2] = "/home/core/gentoo/usr/lib"

	#
	# Walk /etc/ld.so.conf to discover all our library paths
	#
	parse_ld_conf("/home/core/gentoo/etc/ld.so.conf")
	...
	if ((!((pipe) | getline TMP_CHOST)) || (TMP_CHOST == "")) {
		...
		pipe = "/home/core/gentoo/usr/bin/portageq envvar 'CHOST'"
	...
	GCCLIBPREFIX_OLD = "/home/core/gentoo/usr/lib/gcc-lib/"
	GCCLIBPREFIX_NEW = "/home/core/gentoo/usr/lib/gcc/"
				...
				while ((getline la_data < (la_files)) > 0) {
					if (OLDCHOST != "") {
						...
						if (CHOST_CHANGED > 0) {
							...
							#
							gsub("-L/home/core/gentoo/usr/" OLDCHOST "/",
							     "-L/home/core/gentoo/usr/" CHOST "/", la_data)
							# Catch:
							#
