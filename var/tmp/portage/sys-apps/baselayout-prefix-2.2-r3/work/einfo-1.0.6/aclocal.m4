...
BEGIN {RS=" "; FS="/|\n";} {
  ...
  sys_lib_search_path_spec=`$ECHO "/data/home/redlizard/gentoo-prefix-vanilla/lib /data/home/redlizard/gentoo-prefix-vanilla/usr/lib $lt_search_path_spec" | $lt_NL2SP`
else
